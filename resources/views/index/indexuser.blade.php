...
<div class="welcome" style="display:none">
    <p>Hi，等你好久了！</p>
    <a href="{{url('index/login')}}" class="orange">登录</a>
    <a href="{{url('index/register')}}" class="orange">注册</a>
</div>
...
<div class="sub_nav marginB person-page-menu">
    <a href="{{url('index/buyrecord')}}"><s class="m_s1"></s>潮购记录<i></i></a>
    <a href="{{url('')}}"><s class="m_s2"></s>获得的商品<i></i></a>
    <a href="{{url('index/share')}}"><s class="m_s3"></s>我的晒单<i></i></a>
    <a href="{{url('index/mywallet')}}"><s class="m_s4"></s>我的钱包<i></i></a>
...
<div class="footer clearfix">
    <ul>
        ...
        <li class="f_announced"><a href="/index/indexshop" ><i></i>最新揭晓</a></li>
        <li class="f_single"><a href="#" ><i></i>晒单</a></li>
        <li class="f_car"><a id="btnCart" href="/index/indexshopcar" ><i></i>购物车</a></li>
        <li class="f_personal"><a href="/index/indexuser" class="hover"><i></i>我的潮购</a></li>
    </ul>
</div>
