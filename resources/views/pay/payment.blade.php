                ...
                <li>
                    <a href="">
                        ...
                        <dl>
                            ...
                            <dd><em class="buy_number">{{$v['buy_number']}}</em>件/￥<em class="price">{{$v['self_price']}}</em></dd>
                        </dl>
                        <input type="hidden" name="buy_number" class="buy_number" value="{{$v['buy_number']}}">
                    </a>
                </li>
                @endforeach
            <div id="divMore">
	...
	$(document).ready(function(){
		...
		for(var i = 0;i<$('.g-pay-lst li').length;i++){
			...
			total +=parseInt($('.g-pay-lst li').eq(i).find('dd em.price').text())
                *parseInt($('.g-pay-lst li').eq(i).find('dd em.buy_number').text());
